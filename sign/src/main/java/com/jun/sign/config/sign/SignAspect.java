package com.jun.sign.config.sign;
...
import com.jun.sign.config.exception.BusinessException;
import com.jun.sign.util.SignUtil;
...
public class SignAspect {
     ...
     * pointcut.
     */
    @Pointcut("execution(@com.jun.sign.config.sign.Signature * *(..))")
